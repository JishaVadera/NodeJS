...
List all customer data which is order by customerName in descanding order and city in ascending order
-- select *  from customers order by customerName desc, city asc;

List all employees data where employeeNumber is greater than 1300 number and order by jobtitle in descending order and firstname in ascending
-- select * from employees where employeeNumber>=1300 order by jobTitle desc, firstName asc;

List all employees data where employeeNumber is less than 1300 numberd order by jobtitle in descending order and firstname in ascending
